...
export function Networking() {
  return (
    <section id="networking" className="py-24 sm:py-32 bg-slate-50/30 relative overflow-hidden border-t border-slate-200/50">
      ...
      <div className="absolute top-1/4 left-0 w-[550px] h-[550px] bg-[#E0B6CF]/8 rounded-full blur-[130px] pointer-events-none -translate-x-1/2" />
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[300px] bg-[#2451A6]/3 rounded-full blur-[100px] pointer-events-none" />

      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10">

        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto mb-20">
          <div className="inline-flex items-center gap-2.5 px-5 py-2 rounded-full bg-white/80 border border-slate-200/80 text-[#169857] font-display font-bold text-xs uppercase tracking-widest mb-6 shadow-[0_4px_12px_rgba(20,146,87,0.03)]">
            ...
            >
              ...
              <div className="border-t border-slate-100 mt-7 pt-4 flex items-center justify-between text-xs font-bold text-slate-400 group-hover:text-slate-700 transition-colors duration-300">
                ...
                <span className="flex items-center gap-1 transition-colors" style={{ color: card.color }}>
                  Explore <IoArrowForward size={12} className="group-hover:translate-x-0.5 transition-transform" />
                </span>
              </div>
            </motion.div>
          ))}
        ...
        <motion.div
          ...
          className="relative rounded-[2.5rem] overflow-hidden border border-white/60 shadow-[0_25px_50px_rgba(36,81,166,0.06)]"
        >
          {/* Gradient background layers */}
          <div className="absolute inset-0 bg-gradient-to-br from-[#2451A6]/8 via-[#E0B6CF]/6 to-[#169857]/8 pointer-events-none" />
          <div className="absolute inset-0 bg-white/40 backdrop-blur-sm pointer-events-none" />

          {/* Internal glow orbs */}
          <div className="absolute -top-16 -left-16 w-64 h-64 bg-[#2451A6]/10 rounded-full blur-[60px] pointer-events-none" />
          <div className="absolute -bottom-16 -right-16 w-64 h-64 bg-[#169857]/10 rounded-full blur-[60px] pointer-events-none" />
          ...
          <div className="relative z-10 p-8 sm:p-12 lg:p-16 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10">
            ...
            <div className="max-w-2xl">
              <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/60 border border-[#169857]/15 text-[#169857] text-xs font-bold uppercase tracking-widest mb-5 shadow-sm">
                <span className="w-2 h-2 rounded-full bg-[#169857] animate-pulse" />
            ...
            <a
              href="#register"
              className="group inline-flex items-center gap-2.5 bg-[#169857] hover:bg-[#107a49] text-white font-bold text-sm px-8 py-4 rounded-full shadow-lg hover:shadow-[0_15px_35px_rgba(20,146,87,0.3)] transition-all duration-300 transform hover:-translate-y-0.5 shrink-0"
            >
              Join the Community
