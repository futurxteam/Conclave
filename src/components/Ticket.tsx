    ...
    <section id="ticket-booking" className="py-24 sm:py-32 bg-[#fafbfc] relative overflow-hidden border-t border-slate-200/50">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <motion.div
          ...
          className="relative max-w-4xl mx-auto rounded-[2.5rem] bg-gradient-to-br from-[#1a0c0a] via-[#351811] to-[#1a0c0a] text-white p-8 sm:p-12 lg:p-16 overflow-hidden shadow-[0_30px_60px_-15px_rgba(0,0,0,0.4)] border border-white/10 text-center"
        >
          {/* Internal glow orbs */}
          <div className="absolute -top-24 -right-24 w-72 h-72 bg-[#F74A1D]/20 rounded-full blur-[80px] pointer-events-none" />
          <div className="absolute -bottom-24 -left-24 w-72 h-72 bg-[#fbbf24]/12 rounded-full blur-[80px] pointer-events-none" />
          ...
          <div className="relative z-10 flex flex-col items-center">
            {/* Badge */}
            <span className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/10 border border-white/10 text-[#f87171] text-xs font-bold uppercase tracking-widest mb-6">
            ...
            <Link
              to="/ticket-booking"
              className="group inline-flex items-center gap-2.5 bg-gradient-to-r from-[#F74A1D] to-[#ef4444] hover:from-[#c23612] hover:to-[#dc2626] text-white font-bold text-base px-10 py-5 rounded-full shadow-xl hover:shadow-[0_20px_40px_rgba(247,74,29,0.4)] transition-all duration-300 transform hover:-translate-y-0.5"
            >
              Reserve Your Seat
