...
import { Sparkles, ArrowRight, ChevronDown, MessageCircleQuestion } from 'lucide-react';
...
export function FAQ() {
  ...
  return (
    <section id="faq" className="py-24 sm:py-32 bg-slate-50/30 relative overflow-hidden border-t border-slate-200/50">
      ...
      <div className="absolute top-1/4 left-0 w-[550px] h-[550px] bg-[#2551A4]/4 rounded-full blur-[140px] pointer-events-none -translate-x-1/3" />
      <div className="absolute bottom-1/4 right-0 w-[500px] h-[500px] bg-[#D7AEC8]/6 rounded-full blur-[130px] pointer-events-none translate-x-1/3" />
      ...
      <div className="max-w-[900px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          <div className="inline-flex items-center gap-2.5 px-5 py-2 rounded-full bg-white/80 border border-slate-200/80 text-[#2551A4] font-display font-bold text-xs uppercase tracking-widest mb-6 shadow-[0_4px_12px_rgba(37,81,164,0.03)]">
            <MessageCircleQuestion size={14} className="text-[#2551A4]" />
            GOT QUESTIONS?
          </div>
            ...
            return (
              <motion.div
                ...
                className={`
                  ...
                  ${isOpen
                    ? 'bg-white shadow-[0_20px_50px_-12px_rgba(37,81,164,0.1)] border-[#2551A4]/15'
                    : 'bg-white/60 backdrop-blur-sm shadow-[0_8px_24px_rgba(37,81,164,0.03)] border-white/70 hover:bg-white/90 hover:shadow-[0_12px_32px_rgba(37,81,164,0.06)]'
                  }
                `}
              >
                {/* Question Button */}
                ...
                >
                  <div className="flex items-center gap-4 min-w-0">
                    <span
                      className={`
                        ...
                        ${isOpen
                          ? 'bg-[#2551A4] text-white shadow-md'
                          : 'bg-[#2551A4]/5 text-[#2551A4] group-hover:bg-[#2551A4]/10'
                        }
                      `}
                    >
                    ...
                    <h3
                      className={`
                        ...
                        ${isOpen ? 'text-[#2551A4]' : 'text-slate-900 group-hover:text-[#2551A4]'}
                      `}
                    >
                      {faq.q}
                    </h3>
                  ...
                  <motion.div
                    ...
                    className={`
                      ...
                      ${isOpen ? 'bg-[#2551A4]/10 text-[#2551A4]' : 'bg-slate-100 text-slate-400 group-hover:bg-[#2551A4]/5 group-hover:text-[#2551A4]'}
                    `}
                  >
                    <ChevronDown size={18} />
                  </motion.div>
                    ...
                    >
                      <div className="px-7 sm:px-8 pb-7 pt-0">
                        <div className="pl-13 sm:pl-[3.25rem]">
                          <div className="h-px bg-gradient-to-r from-[#2551A4]/10 via-[#D7AEC8]/15 to-transparent mb-5" />
        ...
        <motion.div
          ...
          className="relative rounded-[2rem] overflow-hidden border border-white/60 shadow-[0_20px_50px_rgba(37,81,164,0.06)]"
        >
          {/* Gradient background */}
          <div className="absolute inset-0 bg-gradient-to-br from-[#2551A4]/6 via-[#D7AEC8]/5 to-[#149257]/6 pointer-events-none" />
          <div className="absolute inset-0 bg-white/50 backdrop-blur-sm pointer-events-none" />

          {/* Internal glow */}
          <div className="absolute -top-12 -left-12 w-48 h-48 bg-[#2551A4]/8 rounded-full blur-[50px] pointer-events-none" />
          <div className="absolute -bottom-12 -right-12 w-48 h-48 bg-[#D7AEC8]/10 rounded-full blur-[50px] pointer-events-none" />

          <div className="relative z-10 p-8 sm:p-10 lg:p-12 text-center">
            <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-[#2551A4]/5 border border-[#2551A4]/10 mb-6">
              <Sparkles size={24} className="text-[#2551A4]" />
            </div>
            ...
            <a
              href="#contact"
              className="group inline-flex items-center gap-2.5 bg-[#2551A4] hover:bg-[#1d428a] text-white font-bold text-sm px-8 py-4 rounded-full shadow-lg hover:shadow-[0_15px_35px_rgba(37,81,164,0.3)] transition-all duration-300 transform hover:-translate-y-0.5"
            >
              Contact Us
